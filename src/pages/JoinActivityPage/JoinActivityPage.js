                ...
                <div className="class-detail-info">
                    <div className="class-reservation lflex">
                        ...
                        <div className="flex1 lflex lflex-v jc-center">
                            <div className="sigin-in tTap" onClick={t.openScanner}>
                                <Icon name="barcode"/>
                            </div>
                            <div>签到</div>
                        </div>
                        <div className="flex1 lflex lflex-v jc-center">
                            <div className="sigin-in tTap" onClick={t.goTo.bind(t, '#/sys/map/'+t.props.actId)}>
                                <Icon name="map"/>
                            </div>
                            <div>位置</div>
                        </div>
                    ...
                    <div className="class-reservation lflex">
                        <div className="flex1 lflex lflex-v jc-center">
                            <div className="sigin-in tTap" onClick={t.goTo.bind(t, '#/sys/qrcode/'+t.props.actId)}>
                                <Icon name="weixin"/>
                            </div>
                            <div>群聊</div>
                        </div>
